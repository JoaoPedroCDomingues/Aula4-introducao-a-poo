...
public class Main {
    public static void main(String[] args) {
        ...
        teste = z1.transfereVida(z1, quantia);
        if(teste){
            System.out.println("Transferência de vida realizada com sucesso!");
        }
        else{
            System.out.println("A transferência de vida falhou!");
        }
        System.out.println("Vida adicional de: " + z2.nome);
        quantia = scanner.nextInt();
        teste = z2.transfereVida(z2, quantia);
        if(teste){
            System.out.println("Transferência de vida realizada com sucesso!");
        }
        else{
